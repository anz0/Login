    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                    ...
                    //判断两次密码是否相同
                    String eNmb = editText2.getText().toString();
                    String ePs = editText3.getText().toString();

                    if (eNmb.equals(ePs)) {
                        userPs = editText2.getText().toString();
                    } else {
                        Toast.makeText(RegisterPage.this, "两次输入的密码不一样！", Toast.LENGTH_SHORT).show();
